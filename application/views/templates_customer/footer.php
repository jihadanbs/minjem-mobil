                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                ...
                                <p>Rentalnya Acu adalah Pintu penghubung antara penyedia rental dengan customer. Sebuah wadah untuk penyedia rental dan customer untuk saling terhubung.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                ...
                                <ul class="get-touch">
                                    <li><i class="fa fa-map-marker"></i> Jl. Nusa Indah 2, Sleman</li>
                                    <li><i class="fa fa-mobile"></i> +62 812 5638 2789</li>
                                    <li><i class="fa fa-envelope"></i> rentalnyaacu@gmail.com</li>
                                </ul>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Design by <a href="https://Jihadan.bs" target="_blank">Rental nya Acu</a>
